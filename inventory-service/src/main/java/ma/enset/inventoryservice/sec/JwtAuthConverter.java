...
public class JwtAuthConverter implements Converter<Jwt, AbstractAuthenticationToken> {
   ...
   // convertir un objet de type Jwt en un objet de type AbstractAuthenticationToken qui est l'objet qui contient les informations de l'utilisateur authentifié
    @Override
    ...
    // extraire les roles de l'utilisateur authentifié
