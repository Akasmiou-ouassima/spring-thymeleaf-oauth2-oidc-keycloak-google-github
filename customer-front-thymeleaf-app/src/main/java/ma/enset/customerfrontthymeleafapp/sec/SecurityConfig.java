...
public class SecurityConfig {
    ...
    // il permet de récupérer les informations de configuration du fournisseur d'identité
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .logout((logout) -> logout
                        .logoutSuccessHandler(oidcLogoutSuccessHandler()) // gérer la déconnexion
                        .logoutSuccessUrl("/").permitAll() // rediriger vers la page d'accueil après la déconnexion
                        .clearAuthentication(true) // supprimer l'authentification de l'utilisateur après la déconnexion
                        .deleteCookies("JSESSIONID"))
                .exceptionHandling(eh->eh.accessDeniedPage("/notAutorized"))
                .build();
    }

    // gérer la déconnexion  et rediriger vers la page d'accueil après la déconnexion
    ...
    // récupérer les rôles de l'utilisateur à partir des attributs de l'utilisateur authentifié (id_token) ou (access_token) du fournisseur d'identité
    @Bean
